...
import resources.payloads.Place;
...
public class MapTest {
    ...
    public void testMapAPI(){
        ...
        String response= given().log().all().queryParam("key", "qaclick123").body(Place.getAddPlacePayload())
        ...
        given().log().all().queryParam("key", "qaclick123").queryParam("place_id", place_id)
                .body(Place.GetUpdatePlacePayload(place_id, expectedAddress))
